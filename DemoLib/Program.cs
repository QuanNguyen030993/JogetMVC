...
//string ConnectionString = "Persist Security Info=True;Server=.\\SQLSERVER2016;Database=ERPCore;uid=sa;pwd=password@123;Connection Timeout=60;MultipleActiveResultSets=true;TrustServerCertificate=True;";
