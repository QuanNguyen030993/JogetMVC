...
//public class GuideStepController : ControllerBase
//{
...
//    private readonly IBaseRepository<GuideStep> _repository;
//    private readonly IHttpContextAccessor _httpContextAccessor;
//    private readonly IConfiguration _configuration;

//    public GuideStepController(
//        IBaseRepository<GuideStep> repository,
...
//    {
//        await using var connection = new SqlConnection(_repository._connectionString);
...
//        if (ControllerUtil.IsSuperUser(_configuration, accountName)) return true;
