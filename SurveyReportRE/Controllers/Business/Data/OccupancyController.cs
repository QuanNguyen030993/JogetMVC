...
public class OccupancyController : BaseControllerApi<Occupancy>
{
    private readonly IBaseRepository<Occupancy> _BaseRepository;
    private readonly IConfiguration configuration;

    public OccupancyController(IBaseRepository<Occupancy> BaseRepository, IConfiguration config,IHttpContextAccessor httpContextAccessor) : base(BaseRepository,httpContextAccessor)
    {
