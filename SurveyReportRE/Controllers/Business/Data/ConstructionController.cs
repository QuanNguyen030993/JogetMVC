...
public class ConstructionController : BaseControllerApi<Construction>
{
    private readonly IBaseRepository<Construction> _BaseRepository;
    private readonly IConfiguration configuration;

    public ConstructionController(IBaseRepository<Construction> BaseRepository, IConfiguration config,IHttpContextAccessor httpContextAccessor) : base(BaseRepository,httpContextAccessor)
    {
