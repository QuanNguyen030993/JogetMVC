...
public class OtherExposuresController : BaseControllerApi<OtherExposures>
{
    private readonly IBaseRepository<OtherExposures> _BaseRepository;
    private readonly IConfiguration configuration;

    public OtherExposuresController(IBaseRepository<OtherExposures> BaseRepository, IConfiguration config,IHttpContextAccessor httpContextAccessor) : base(BaseRepository,httpContextAccessor)
    {
