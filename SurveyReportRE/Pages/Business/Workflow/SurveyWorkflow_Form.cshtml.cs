...
{
    public class SurveyWorkflow_FormModel : PageModel
    {
        //private readonly ILogger<SurveyWorkflow> _logger;
        public static string ModelName { get; set; } = "";
        public static int Id { get; set; } = 0;
        public static string SchemeModelName { get; set; } = "";
        public SurveyWorkflow_FormModel(ILogger<SurveyWorkflow> logger)
        {
            //_logger = logger;
        }
