...
{
    public class Quotation_Request_FormModel : PageModel
    {
        ...
        public Quotation_Request_FormModel(ILogger<Quotation_Request_FormModel> logger, IConfiguration configuration, Microsoft.Extensions.Options.IOptionsMonitor<BlobStorageSettings> blobStorageSettings, IHttpContextAccessor httpContextAccessor)
        {
