...
namespace SurveyReportRE.Pages.Business.MasterData
{
    public class Outline_FormModel : PageModel
    {
        //private readonly ILogger<Outline_FormModel> _logger;
        ...
        public Outline_FormModel(ILogger<Outline_FormModel> logger, IConfiguration config)
        {
            //_logger = logger;
        }
        public async void OnGet(int? pageNum, int? refPageNum,string jsonConfig) { ViewData[nameof(JsonConfig)] = jsonConfig;
            ...
            SchemeModelName = nameof(Outline);
