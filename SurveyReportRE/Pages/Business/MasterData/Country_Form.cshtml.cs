...
{
    public class Country_FormModel : PageModel
    {
        //private readonly ILogger<Country_FormModel> _logger;
        ...
        public Country_FormModel(ILogger<Country_FormModel> logger)
        {
            //_logger = logger;
        }
        public void OnGet(int? pageNum)
        {
            ...
            SchemeModelName = nameof(Country);
