...
export interface GridEditingConfig<T> {
  ...
  newRowKey?: () => GridKey;
  form?: { colCount?: number };
  popup?: { title?: string; width?: number | string; height?: number | string };
  texts?: Partial<{ add: string; edit: string; delete: string; save: string; cancel: string; saveAll: string; cancelAll: string }>;
}
...
export interface DataGridProps<T extends Record<string, unknown>> {
  ...
  rowNumber?: { visible?: boolean; mode?: 'page' | 'absolute' };
